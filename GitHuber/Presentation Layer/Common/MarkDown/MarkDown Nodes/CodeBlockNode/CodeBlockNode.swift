...
final class CodeBlockNode: ASDisplayNode {
    ...
    init(codeBlock: CodeBlock, style: DocumentStyle, nested: Bool = false) {
    ...
    convenience init(model: CodeBlockNodeModel) {
        self.init(codeBlock: model.codeBlock, style: model.style, nested: model.nested)
    }
