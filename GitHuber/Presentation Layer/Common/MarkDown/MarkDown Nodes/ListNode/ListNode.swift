...
final class ListNode: ASDisplayNode, Linkable, LinkDelegate {
    ...
    init(list: List, style: DocumentStyle, nested: Bool = false) {
    ...
    convenience init(model: ListNodeModel) {
        self.init(list: model.list, style: model.style, nested: model.nested)
    }
    ...
    ///     - style: The document style.
    func setupList(_ list: List, ordered: Bool, style: DocumentStyle) {
...
extension ListNode: ASTextNodeDelegate {
