...
final class FootnoteDefinitionNode: ASDisplayNode, ASTextNodeDelegate, Linkable, LinkDelegate {
    ...
    init(footnoteDefinition: FootnoteDefinition, style: DocumentStyle, nested: Bool = false) {
    ...
    convenience init(model: FootnoteDefinitionNodeModel) {
        self.init(footnoteDefinition: model.footnoteDefinition, style: model.style, nested: model.nested)
    }
...
private extension FootnoteDefinitionNode {
    /// Configures a footnote definition.
    ///
    /// - Parameters:
    ///     - footnoteDefinition: The markdown footnote definition.
    ///     - style: The document style.
    func setupFootnoteDefinition(_ footnoteDefinition: FootnoteDefinition, style: DocumentStyle) {
