...
extension Block {
    ...
    func displayNode(style: DocumentStyle, nested: Bool = false) -> ASDisplayNode? {
    ...
    func cellNode(style: DocumentStyle = DefaultDocumentStyle(),
                  nested: Bool = false) -> BaseCellNode? {
